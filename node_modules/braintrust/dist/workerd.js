...
function wrapGenkitModule(module2) {
...
function moduleProxy(module2) {
  const shadowTarget = Object.create(module2);
  return new Proxy(shadowTarget, {
    get(target, prop, receiver) {
      if (typeof prop === "string" && isHuggingFaceConstructorKey(prop)) {
        const value = Reflect.get(module2, prop, receiver);
      ...
      switch (prop) {
        ...
        default:
          return Reflect.get(module2, prop, receiver);
      }
    }
  });
}
...
var evalParametersSchema = import_v311.z.record(
  ...
  import_v311.z.union([
    ...
    import_v311.z.object({
      type: import_v311.z.literal("model"),
      default: import_v311.z.string().optional(),
      description: import_v311.z.string().optional()
    }),
...
var staticParametersSchema = import_v313.z.record(
  ...
  import_v313.z.union([
    ...
    import_v313.z.object({
      type: import_v313.z.literal("model"),
      default: import_v313.z.string().optional(),
      description: import_v313.z.string().optional()
    }),
    import_v313.z.object({
