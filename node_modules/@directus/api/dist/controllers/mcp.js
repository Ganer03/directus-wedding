...
//#region src/controllers/mcp.ts
const router = Router();
const mcpHandler = async_handler_default(async (req, res) => {
	const { mcp_enabled, mcp_allow_deletes, mcp_prompts_collection, mcp_system_prompt, mcp_system_prompt_enabled } = await new SettingsService({ schema: req.schema }).readSingleton({ fields: [
		"mcp_enabled",
		"mcp_allow_deletes",
